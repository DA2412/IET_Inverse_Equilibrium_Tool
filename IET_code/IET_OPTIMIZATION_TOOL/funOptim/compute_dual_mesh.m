...
if disegnaMesh
            ...
            plot(app.PlasmaSurfacesPlot,[nbar(1) n1d(1)],[nbar(2) n1d(2)],'-r')
     plot(app.PlasmaSurfacesPlot,[nbar(1) n2d(1)],[nbar(2) n2d(2)],'-r')
     plot(app.PlasmaSurfacesPlot,[nbar(1) n3d(1)],[nbar(2) n3d(2)],'-r')

     plot(app.PlasmaSurfacesPlot,app.R_boundary_finale,app.Z_boundary_finale,'-r','linewidth',2);
title(app.PlasmaSurfacesPlot,'Mesh and boundary')
